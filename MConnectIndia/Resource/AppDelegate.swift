...
class AppDelegate: UIResponder, UIApplicationDelegate {
    ...
    func deleteIterm()
    {
        ...
        let dbUrl = supportDirectory.appendingPathComponent("MConnectIndia.sqlite")
        print("dbUrl",dbUrl)
        do {
    ...
    lazy var managedObjectModel: NSManagedObjectModel = {
        let modelURL = Bundle.main.url(forResource: "MConnectIndia", withExtension: "momd")
        print(modelURL ?? "")
        return NSManagedObjectModel(contentsOf: modelURL!)!
    }()
    lazy var persistentContainer: NSPersistentContainer = {
        let container = NSPersistentContainer(name: "MConnectIndia")
    ...
    lazy var persistentStoreCoordinator: NSPersistentStoreCoordinator = {
        ...
        let supportDirectory = FileManager.default.urls(for: .documentDirectory, in: .userDomainMask).first!
        let url = supportDirectory.appendingPathComponent("MConnectIndia.sqlite")
        print(url)
